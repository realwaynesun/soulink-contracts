...
///   X Layer (chain 196):
///     forge script Deploy --profile xlayer --rpc-url xlayer --broadcast --verify
///   All require DEPLOYER_PRIVATE_KEY env var set.
contract Deploy is Script {
    ...
    address constant XLAYER_USDC = 0x74b7F16337b8972027F6196A17a631aC6dE26d22;
    ...
    function run() external {
        ...
        } else if (block.chainid == XLAYER_MAINNET_CHAIN_ID) {
            usdcAddress = XLAYER_USDC;
        } else {
